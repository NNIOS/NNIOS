...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene,
        ...
        // 🔑 Check token or userId
        if let token = UserDefaults.standard.string(forKey: "authToken"), !token.isEmpty {
            // ✅ User already logged in → go to Step 1/2/3 controller
            let homeVC = storyboard.instantiateViewController(withIdentifier: "NeigbrnookViewController") as! NeigbrnookViewController
