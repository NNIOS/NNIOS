...
class SearchNewNeighouhoodViewController: UIViewController,  UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, CLLocationManagerDelegate{
...
//            locationManager.requestWhenInUseAuthorization()
    ...
    func navigateToRegisterSecondVC() {
        if let registerSecondVC = storyboard?.instantiateViewController(withIdentifier: "NewRegistationSecondStepVC") as? NewRegistationSecondStepVC {
            ...
            registerSecondVC.userProfileData = self.userProfileData
