...
//  iLogic Intell
//
//  Created by Rachit Kumar on 26/06/18.
//  Copyright © 2021 Rachit Kumar. All rights reserved.
//
...
- (void)resetNavButtons {
    ...
    if (_menuFlags.canShowRight) {
        ...
        [btn setBackgroundImage:[UIImage imageNamed:@"Avtar"] forState:UIControlStateNormal];
