...
class NewPostCollectionViewCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
            super.awakeFromNib()
            // Ensure contentMode is properly set
        profileImgView.contentMode = .scaleAspectFill // Or .scaleAspectFit
        profileImgView.clipsToBounds = true  // Ensure that image does not overflow outside bounds
