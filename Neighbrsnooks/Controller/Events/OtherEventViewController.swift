...
@available(iOS 16.0, *)
class OtherEventViewController:  BaseViewController , UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func callEventListWebService(_ completionClosure: @escaping () -> ()) {
        ...
        let idE = UserDefaults.standard.string(forKey: "idEv")
          ...
          WebService.sharedInstance.callEventListWebService(withParams: dictParams) { data in
           ...
           //   UserDefaults.standard.set(self.EventListData?.c?.name, forKey: "name")
