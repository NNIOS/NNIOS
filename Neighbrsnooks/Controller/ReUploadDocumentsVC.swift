...
class ReUploadDocumentsVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate  {
    ...
    @IBOutlet weak var lblCityEdit: UILabel!
...
//    var cityDropdownData = DropDown()
    ...
    func setUp(){
        ...
        //     neighbourhoodDataShowTableView.register(UITableViewCell.self, forCellReuseIdentifier: "NeighbourhoodDataShowTableViewCell")
...
//            self.cityDropdownData.dataSource = self.cityName
    ...
    func callNeighorhodStatusStateCity() {
        let userID = UserDefaults.standard.string(forKey: "userid") ?? ""
        let dictParams: [String: Any] = [
            "area": lblArea.text ?? "", // Using lblArea to pass neighborhood
            "countryid": "100",
