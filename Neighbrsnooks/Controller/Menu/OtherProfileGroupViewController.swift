//
//  OtherProfileGroupViewController.swift
...
@available(iOS 16.0, *)
class OtherProfileGroupViewController: BaseViewController, ConfirmDelegate  {
    func tapConfirm() {
...
@available(iOS 16.0, *)
extension OtherProfileGroupViewController: UITableViewDataSource, UITableViewDelegate{
