...
protocol PostmyProfileTableViewCellDelegate: AnyObject {
    func didSelectItem(with postImage: PostImage, username: String, allImages: [PostImage])
}



protocol MyProfilePostTableViewCellDelegate: AnyObject {
...
class MyProfilePostTableViewCell: UITableViewCell,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    weak var delegateCell: MyProfilePostTableViewCellDelegate?
    ...
    var UserName = ""
    weak var delegate: PostmyProfileTableViewCellDelegate?
    ...
    @IBAction func actionThreeDot(_ sender: Any) {
        DotCallback?(postid)
    }
    ...
    func pauseAllVideosInVisibleCells() {
        let visibleCells = collectionViewBanner.visibleCells.compactMap { $0 as? MyProfilePostCollectionViewCell }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MyProfilePostCollectionViewCell", for: indexPath) as! MyProfilePostCollectionViewCell
